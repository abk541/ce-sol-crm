    ...
    >
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <Link to="/notifications">
          <button className="relative w-9 h-9 rounded-xl flex items-center justify-center text-slate-500 hover:text-indigo-600 hover:bg-indigo-50 transition-all">
            <Bell size={16} />
            {unread > 0 && (
        ...
        {currentUser && (
          <div className="flex items-center gap-2.5 cursor-pointer group">
            <div className="text-right hidden sm:block">
              <p className="text-xs font-semibold text-slate-700 leading-none group-hover:text-indigo-600 transition-colors">{currentUser.name}</p>
